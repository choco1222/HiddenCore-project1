...
public class DailyReportDAO {
	...
	public static List<ActivelogRow> getActiveLogs(String userId) {
		...
		try (Connection conn = ConDB.getCon(); PreparedStatement pstmt = conn.prepareStatement(sql)) {
	 ...
	 */
	public static DailyReportDTO.DailyAnalysis getDailyAnalysis(String userId, String analysisDate) {
