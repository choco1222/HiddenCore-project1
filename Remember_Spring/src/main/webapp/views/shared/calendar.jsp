	...
	<div class="calendar-container">
		<div class="calendar-header">
			<button class="nav-button"
				onclick="location.href='CalendarServlet?year=${prevYear}&month=${prevMonth}'">◀</button>
			<div class="calendar-title">${year}년${month}월</div>
			<button class="nav-button"
				onclick="location.href='CalendarServlet?year=${nextYear}&month=${nextMonth}'">▶</button>
		</div>
		...
		<div class="calendar-grid">
			...
			<c:forEach var="day" begin="1" end="${daysInMonth}">
				...
				<div class="calendar-day ${isToday ? 'today' : ''}" id="day-${day}"
					onclick="selectDay(${year}, ${month}, ${day})">
