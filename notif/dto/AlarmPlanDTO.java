...
public class AlarmPlanDTO {
    ...
    public AlarmPlanDTO(String routineType, int seq, LocalTime baseTime, LocalTime fireTime,
                        String stage, String title, String body) {
    ...
    public LocalTime getFireTime() { return fireTime; }
