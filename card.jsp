...
<body>
	<div class="container">
		<div id="menuScreen" class="menu">
			...
			<p>
				<strong>같은 카드</strong>를 찾아주세요!<br>
			</p>
			</div>
		...
		<div id="gameScreen" class="hidden">
			...
			<div id="gameoverScreen" class="hidden gameover">
				...
				<div class="gameover-buttons">
					...
					<button class="btn btn-secondary-small" onclick="resetGame()">메뉴로
						돌아가기</button>
				</div>
			</div>
	...
	<script>
        ...
        function endGame(success) {
            ...
            fetch(CTX + '/GameLogSaveServlet.do', {
                 ...
                 body: params.toString()   // (안전) URLSearchParams는 toString() 추천
               })
