...
<body data-join-error="${not empty sessionScope.joinError ? sessionScope.joinError : ''}">
    <% 
    	String errMessage = (String) session.getAttribute("joinError");
        if (errMessage != null) {
        	%> <script>
            	alert('<%= errMessage %>');
        		console.log('계정 생성 불가:', '<%= errMessage %>');
            </script> <%
    ...
    <div class="container">
        <div class="survey-wrapper">
            ...
            <div class="role-indicator" id="roleIndicator">
                <span class="role-badge">${param.userRole == 'patient' ? '환자' : '보호자'}</span>
            </div>
            ...
            <form class="auth-form" id="joinForm" action="${pageContext.request.contextPath}/login/join" method="post" onsubmit="handleJoin(event)">
           ...
           required>
                    ...
                    <div class="form-group">
                        ...
                        <div class="gender-selection">
                            <button type="button" class="gender-btn" data-value="male" onclick="selectGender(this, 'male')">남자</button>
                    ...
                    <div class="form-group" style="margin-top: 2rem;">
                        <div class="terms-container">
                            ...
                            <div class="term-footer">
                                <a href="#" class="term-footer-link" onclick="event.preventDefault();">안내</a>
                            </div>
                        </div>
                    </div>
                </div>
